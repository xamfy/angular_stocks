...
export class DataService {
  ...
  getCryptoData(search_term: string) {
    ...
    'function=CURRENCY_EXCHANGE_RATE&from_currency=' + search_term + '&to_currency=USD&apikey=' + this.API_KEY;
    return this.http.get(this.API_URL_CRYPTO);
  }

  getShareData(search_term: string) {
    this.API_URL_SHARES = 'https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol='
    + search_term + '&apikey=' + this.API_KEY;
